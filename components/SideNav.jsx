        ...
        return (
            ...
            <div className="inner">
                <ul className="actions vertical">
                    <li className="nav-li"><a href="#" className="button">Watch Online</a></li>
                </ul>
                <ul className="links">
                    <li className="nav-li"><Link href="/"><a className="nav-link"><span onClick={this.props.closeMenu}>Home</span></a></Link></li>
                        <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(1)}>Who We Are</span></li>
                        <Dropdown
                            ...
                            item7="Times & Directions"
                            url7="/who-we-are/times-directions"
                        />
                    <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(2)}>Get Connected</span></li>
                    <Dropdown
                    hidden={this.state.activeIndex === 2 ? "" : "hide"}
                            ...
                            item5="Times & Directions"
                            url5="/get-connected/times-directions"
                            item6="Contact Us"
                            url6="/get-connected/contact-us"
                        />
                    <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(3)}>Ministries</span></li>
                    <Dropdown
                    hidden={this.state.activeIndex === 3 ? "" : "hide"}
                            ...
                            item3="Communications"
                            url3="/ministries/communications"
                            item4="Discipleship"
                            url4="/ministries/discipleship"
                            item5="Evangelism & Visitation"
                            url5="/ministries/evangelism-visitation"
                            item6="Praise & Worship"
                            url6="/ministries/praise-worship"
                            item7="Men's Ministries"
                            url7="/ministries/men"
                        />
                    <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(4)}>News & Events</span></li>
                    <Dropdown
                    hidden={this.state.activeIndex === 4 ? "" : "hide"}
                            item1="Event Flyers"
                            url1="/events/event-flyers"
                        />
                    <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(5)}>Media & Resources</span></li>
                    <Dropdown
                    hidden={this.state.activeIndex === 5 ? "" : "hide"}
                            ...
                            item3="Forms"
                            url3="/media-resources/forms"
                        />
                    <li className="nav-li"><span className="nav-link" onClick={event => this.handleClick(6)}>Quick Links</span></li>
                    <Dropdown
            ...
            <a className="close" onClick={this.onClose} href="javascript:;">Close</a>
        </nav>
            )
        }
}
